...
public partial class ScheduleBlock : ObservableObject
{
    ...
    public string Time { get; set; } = string.Empty;      // "HH:MM" 24-hr stored; displayed as 12-hr
    public string Label { get; set; } = string.Empty;     // Human-readable description of the activity
    public string Category { get; set; } = string.Empty;  // One of 8 category keys (e.g., "work", "study")
